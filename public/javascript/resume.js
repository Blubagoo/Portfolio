...
function generateIntroduction() {
	return `
		<div id="bio" class="well">
			<h2 class="header">Introduction</h2><br>
				...
				opportunity in this field. I am very excited to get into the nuances of Javascript
				and even trying out Tensorflow.js.</p><br><br>
				<p class="info1 info">While I was studying at Thinkful, I had the chance to learn from real professionals who are already in this
				industry, and have been able to learn the core essentials of writing good modular
				code.  I cant wait to see how future technologies will shape my career!</p>
		</div>
	`
}
